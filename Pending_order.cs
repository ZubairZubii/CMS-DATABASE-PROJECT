...
namespace CMS
{
    public partial class Pending_order : Form
    {
        ...
        private void Pending_order_Load(object sender, EventArgs e)
        {
        ...
        private void no_pen_Click(object sender, EventArgs e)
        {

        }

        private void no_prog_Click(object sender, EventArgs e)
        {

        }

        private void no_com_Click(object sender, EventArgs e)
        {

        }

        private void total_order_Click(object sender, EventArgs e)
        {
